    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { type: "bullets", items: [
            ...
            { term: "Empathy maps", desc: "2x2 grids capturing what users Say, Think, Do, and Feel." },
            { term: "Diary studies", desc: "Longitudinal self-reporting by users over days or weeks." },
          ]},
          { type: "callout", label: "Critical Principle", text: "Seek to understand the difference between stated needs and latent needs. The goal is not to gather data it is to build genuine understanding of human motivations, frustrations, workarounds, and aspirations." },
      ...
      },
      {
        ...
        blocks: [
          ...
          { type: "bullets", items: [
            ...
            { term: "How Might We questions", desc: "Reframing problems as opportunities." },
      ...
      },
      {
        ...
        blocks: [
          ...
          { type: "stat", value: "50-200+", label: "Ideas before filtering", footnote: "After generating ideas, teams use dot-voting, effort/impact matrices, or structured scoring to converge on 2-5 concepts worth prototyping." },
        ],
      },
      {
        id: "dt-prototype",
        ...
        content: "",
        blocks: [
          { type: "para", text: "Prototyping is the practice of making ideas tangible for the purpose of learning, not delivery. A prototype is any artifact, paper sketch, cardboard model, clickable wireframe, or roleplay scenario that allows a team to test an assumption cheaply and quickly." },
      ...
      },
      {
        ...
        blocks: [
          ...
          { type: "bullets", items: [
            ...
            { term: "Think-aloud protocol", desc: "Ask users to narrate their experience." },
            { term: "Test with extreme users", desc: "People at the edges of your target audience reveal hidden problems." },
            { term: "5-user rule", desc: "Nielsen Norman research shows 5 participants uncover about 85 percent of usability issues." },
      ...
      },
      {
        ...
        blocks: [
          ...
          { type: "bullets", items: [
            { term: "Empathize to Define to Empathize", desc: "New research reveals the initial framing was wrong." },
            { term: "Prototype to Define", desc: "Building reveals the team misunderstood the core problem." },
            { term: "Test to Ideate", desc: "User feedback invalidates the chosen solution direction." },
          ...
          { type: "callout", label: "Organizational Implications", text: "Design Thinking requires psychological safety, teams must feel comfortable abandoning ideas they have invested in, sharing half-formed concepts, and embracing failure as evidence." },
        ],
      },
    ],
  },
